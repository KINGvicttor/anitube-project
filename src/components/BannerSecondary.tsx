                        ...
                        <div className="container mx-auto flex items-center w-full h-full">
                            <div className="w-[50%] h-[70%] flex flex-col">
                                ...
                                <div className="w-72 flex justify-between mt-4">
                                    <button className="px-3 py-2 flex border border-primary bg-primary justify-center items-center rounded-lg hover:bg-transparent">
                                    ...
                                    <button className="px-3 py-2 flex border border-primary bg-transparent justify-center items-center rounded-lg hover:bg-primary">
                                        <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
