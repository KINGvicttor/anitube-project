export const BannerSecondary = () => {
    return (
        <section className="w-full h-[400px] bg-cover bg-center bg-[url('https://media.kitsu.app/anime/12/cover_image/21ecb556255bd46b95aea4779d19789f.jpg')]">
            <div className="flex justify-center items-center w-full h-full bg-radial from-50% from-transparent to-black">
                <div className="container mx-auto px-4 w-full h-[350px] flex flex-col justify-end items-start lg:px-0">
                    <div className="flex flex-col w-[280px] text-start lg:w-[500px]">
                        ...
                        <h1 className="font-bold text-4xl mt-2 mb-2 lg:text-7xl">One Piece</h1>
                    ...
                    <div className="w-[280px] flex mb-10 mt-4 lg:w-full">
