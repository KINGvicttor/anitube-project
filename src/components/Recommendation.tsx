        ...
        <div className="container mx-auto flex flex-col w-full">
            ...
            <div className="container h-[500px] w-full flex flex-col flex-wrap justify-between items-center px-4 overflow-hidden sm:px-0 md:px-0 lg:px-0 lg:flex-row lg:flex-nowrap lg:h-[250px] lg:mb-[30px]">
                {dataCtx?.animesData.slice(10, 15).map(anime => (
                    <div key={anime.id} className="flex justify-start w-56 h-56 rounded-lg lg:w-60 cursor-pointer hover:h-60 hover:ease-in-out hover:duration-500 bg-center bg-cover" style={{backgroundImage: `url('${anime.attributes.posterImage.original}')`}}>
